...
public class MakeChange {
	...
	public void run() {
		// Get user information on asking price and money tendered.
		...
		// Determine if amount tendered is to little or the exact amount
	...
	public void calculateChange() {
		...
		// Determine how much of each dollar increment is required to make even change
		...
		// Determine how much of each coin value is required to make even change
